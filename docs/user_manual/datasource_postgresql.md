...
!!! Tip ""
    ...
    - 网络连通：SQLBot 所在环境可直连 PostgreSQL 主机（若在内网或防火墙后，请先开放 3306 端口或映射安全端口）；
...
![配置postgresql](../img/user_manual/datasource/add_postgresql.png)
...
![配置postgresql](../img/user_manual/datasource/save_postgresql.png)

!!! Tip ""
    对创建完成的 PostgreSQL 数据源对可直接开启智能问数。

![配置postgresql](../img/user_manual/datasource/question_postgresql.png)
