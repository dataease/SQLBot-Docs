...
!!! Tip ""
    ...
    **使用前提：需先完成 [AI 模型配置]()，并添加至少一个可用[数据源](../user_manual/datasource_description.md)，方可发起问数操作。**
...
- 每个问答结果均伴随 SQL 查询语句；
- 点击图表右上角【查看 SQL】，可复制语句用于验证或调整；

### 3.4 收藏至仪表板

- 可将图表收藏至已创建的仪表板，便于集中查看、定期汇报或团队共享；
