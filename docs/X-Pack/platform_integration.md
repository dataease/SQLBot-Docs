...
![对接企业微信](../img/user_manual/X-Pack/平台对接扫码登录.png)
...
![对接企业微信](../img/user_manual/X-Pack/企业微信对接6.png)

![对接企业微信](../img/user_manual/X-Pack/企业微信对接7.png)
...
![对接企业微信](../img/user_manual/X-Pack/企业微信对接8.png)

![对接企业微信](../img/user_manual/X-Pack/企业微信对接9.png)

!!! Abstract ""
    在 Web 网页里授权回调域，域名请根据实际情况进行修改。

![对接企业微信](../img/user_manual/X-Pack/企业微信对接10.png)

!!! Abstract ""
    要支持扫码登录，需要进行企业微信授权登录的设置。

![对接企业微信](../img/user_manual/X-Pack/企业微信对接11.png)

!!! Abstract ""
    根据以上信息完成下图界面的信息录入并校验、保存。

![对接企业微信](../img/user_manual/X-Pack/企业微信校验成功.png)
...
![对接企业微信](../img/user_manual/X-Pack/企业微信应用首页.png)

!!! Abstract ""
    在企业微信工作台中找到 DataEase 应用，PC 端和移动端点击该应用即可免登访问 SQLBot。

![对接企业微信](../img/user_manual/X-Pack/企业微信界面.png)
## 2 钉钉设置
### 2.1 配置平台对接信息
!!! Abstract ""
...
![对接钉钉平台](../img/user_manual/X-Pack/钉钉创建应用.png)

!!! Abstract ""
    在弹出的【创建企业内部应用】对话框中输入应用的相关信息后确认即可。

![对接钉钉平台](../img/user_manual/X-Pack/钉钉填写应用名称.png)
...
![对接钉钉平台](../img/user_manual/X-Pack/钉钉分享设置.png)
...
![对接钉钉平台](../img/user_manual/X-Pack/钉钉安全设置.png)

!!! Abstract ""
    权限控制，进入到【权限管理】中，添加权限。

![对接钉钉平台](../img/user_manual/X-Pack/钉钉权限开通1.png)

!!! Abstract ""
    所需权限如下图所示。

![对接钉钉平台](../img/user_manual/X-Pack/钉钉权限开通2.png)

!!! Abstract ""
    按照以上信息完成下图所示的平台对接配置即可。

![对接钉钉平台](../img/user_manual/X-Pack/钉钉校验成功.png)
...
![对接钉钉平台](../img/user_manual/X-Pack/钉钉免密.png)

![对接钉钉平台](../img/user_manual/X-Pack/钉钉应用内部界面.png)
...
![对接飞书平台](../img/user_manual/X-Pack/飞书对接1.png)

![对接飞书平台](../img/user_manual/X-Pack/飞书对接2.png)

![对接飞书平台](../img/user_manual/X-Pack/飞书对接3.png)

!!! Abstract ""
    创建应用，在弹出的【创建应用】对话框中输入应用的相关信息后确认即可，此处创建一个名叫“SQLBot 测试”的应用。

![对接飞书平台](../img/user_manual/X-Pack/飞书对接4.png)

!!! Abstract ""
    点击【确定创建】按钮后，完成应用创建并进入应用。提醒进行配置和发布，再进行配置后，进行版本发布。

![对接飞书平台](../img/user_manual/X-Pack/飞书对接5.png)

!!! Abstract ""
    新建 App，添加网页应用，设置桌面端主页为 SQLBot 服务器地址。如果是 IP 地址，则填入 http(s)://域名/。
![对接飞书平台](../img/user_manual/X-Pack/飞书对接6.png)

![对接飞书平台](../img/user_manual/X-Pack/飞书对接7.png)
...
![对接飞书平台](../img/user_manual/X-Pack/飞书对接8.png)

!!! Abstract ""
    应用授权，在应用的【权限管理】里进行应用的相关授权，具体权限参考下图：
![对接飞书平台](../img/user_manual/X-Pack/飞书对接9.png)

!!! Abstract ""
    新建应用版本，在应用的【版本管理与发布】中创建应用版本，如下图所示。

![对接飞书平台](../img/user_manual/X-Pack/飞书对接10.png)

![对接飞书平台](../img/user_manual/X-Pack/飞书对接11.png)

!!! Abstract ""
    申请线上发布并自动审核。

![对接飞书平台](../img/user_manual/X-Pack/飞书对接12.png)


!!! Abstract ""
    获取应用 ID 和应用密钥，完成下图所示的平台对接配置即可。

![对接飞书平台](../img/user_manual/X-Pack/飞书对接校验成功.png)
...
![对接飞书平台](../img/user_manual/X-Pack/飞书免密登录.png)

![对接飞书平台](../img/user_manual/X-Pack/飞书应用内部界面.png)
...
![同步用户](../img/user_manual/X-Pack/同步用户按钮.png)

!!! Abstract ""
     勾选所需同步的用户后,点击确认即可。

![同步用户](../img/user_manual/X-Pack/同步平台用户界面.png)

![同步用户](../img/user_manual/X-Pack/同步用户成功.png)
